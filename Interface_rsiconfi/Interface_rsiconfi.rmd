...
get_lista_instituicao<- function(opcao){
  ...
  if(opcao$escopo == "Governo Federal"){
    ...
    } else if (opcao$tipo_cons_mun=="Por faixa populacional"){
...
generate_graph<- function(opcao){
  ...
  opcao_uf <- opcao$tipo_cons_mun=="Todos de uma ou mais UFs" 
...
generate_script<- function(opcao){
  ...
  if (opcao$topico ==1){
    ...
    if (opcao_uf){
      ...
      lines_script[4,1]<- paste0("df_rec <- rsiconfi::get_dca_mun_state(c(",lista_ano,"),'I-C',c(", lista_instituicao_script,"))")
      
      
    } else{
      
      lines_script[4,1]<- paste0("df_rec <- rsiconfi::get_dca(c(",lista_ano,"),'I-C',c(", lista_instituicao_script,"))")
  ...
  if (opcao$topico ==2){
    ...
    if (opcao_uf){
      ...
      lines_script[4,1]<- paste0("df_rec <- rsiconfi::get_dca_mun_state(c(",lista_ano,"),'I-D',c(", lista_instituicao_script,"))")
      
      
    } else{
      
      lines_script[4,1]<- paste0("df_rec <- rsiconfi::get_dca(c(",lista_ano,"),'I-D',c(", lista_instituicao_script,"))")
  ...
  if (opcao$topico ==3){
    ...
    if (opcao_uf){
      ...
      lines_script[5,1]<- paste0("df_func <- rsiconfi::get_dca_mun_state(c(",lista_ano,"),'I-E',c(", lista_instituicao_script,"),arg_cod_conta =c(", lista_funcao,"))")
      
      
    } else{
      
      lines_script[5,1]<- paste0("df_func <- rsiconfi::get_dca(c(",lista_ano,"),'I-E',c(", lista_instituicao_script,"),arg_cod_conta =c(", lista_funcao,"))")
