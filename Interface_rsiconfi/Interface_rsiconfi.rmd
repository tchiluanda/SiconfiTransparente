...
hidden(
  div(id = "tipo_cons_mun", radioButtons("tipo_cons_mun", label ="Informe o filtro para municípios", choices = c("Escolher de uma lista", "Todos de uma ou mais UFs","Por Mesoregião", "Por faixa populacional - quartis", "Por faixa populacional - grupos ibge", "Por posição PIB per-capita" ), selected = "Escolher de uma lista"))
...
hidden(
         div(id = "mun_pib_pc", sliderInput("mun_pib_pc", label ="Selecione uma faixa de posições", min= 1, max= NROW(ibge_pib_mun), step = 100,value = c(1,100))))
